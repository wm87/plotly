...
from proj1.gui.proj1_v1 import GUIProj1V1
...
if __name__ == '__main__':
    ...
    try:
        ...
        layout_list.append(html.Div([
            ...
            html.H1('Module proj1 not found', style={'text-align': 'center', 'font-size': '32px'}),
            html.Div(style={'height': '10px'})
        ]))
    ...
    try:
        file_path = 'proj1/data/'
        with open(file_path + 'messorte.json', 'r') as data:
            module_proj2 = GUIProj1V2(app, json.load(data), file_path, 365)
            app = module_proj2.get_app()
            layout_list.append(module_proj2.get_layout())
    except FileNotFoundError as e:
        print(f"Error: {e}")
        layout_list.append(html.Div([
            html.Div(style={'height': '10px'}),
